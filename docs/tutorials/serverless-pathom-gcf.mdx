...
To make the GPC integration I'll use the library [google-cloud-functions-clojure](https://github.com/pepijn/google-cloud-functions-clojure).
...
{:paths
 ...
 :deps
 {com.wsscode/pathom3                         {:git/url "https://github.com/wilkerlucio/pathom3" :sha "acf3134aa52668d83cffd326c46fca1ef0120e99"}
