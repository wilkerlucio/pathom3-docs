...
This tutorial will demonstrate how to use Pathom 3 in Babashka scripts.

For this, I'll re-use the sample example from the [Pathom Tutorial](), the code is mostly
