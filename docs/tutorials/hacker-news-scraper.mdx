...
(comment
  ; WARNING: maybe you can't finish running this before HN throttle you, when I tried
  ; to run too many things I started getting 403 from Hacker News, which makes sense.
  ; if you can, this gets data from all users from all items and comments in the first
  ; page of news
  (p.eql/process env
    [{:hacker-news.page/news
      [:hacker-news.item/age
