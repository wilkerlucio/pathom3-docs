...
:::danger
Pathom 3 is a library in development and at this stage I can only recommend its usage
for experimental things and for playing. If you are looking for a library ready to
use in production please use [Pathom 2](https://wilkerlucio.github.io/pathom/v2/).
:::
...
figuring what resolvers to call, in what order.	resolvers to call, in what order.
