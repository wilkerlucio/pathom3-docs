...
- Add support to load the index via EQL (though `::pci/indexes` attribute)
...
; activate lenient mode, to make the process tolerant to errors in the process, localizing errors per attribute
