...
which is in the available context. It's the same path we described before with the table
column associations.
...
I like to encourage you to go and play with it a bit more, here is an exercise suggestion:
