...
It's possible to send a function to transform the resolver after its instantiation.
...
The transform function receives the resolver and you should output a resolver.
