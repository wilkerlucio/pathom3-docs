...
GraphQL is another great target, and you can find the tools to integrate with it
at the [Pathom 3 GraphQL repository](https://github.com/wilkerlucio/pathom3-graphql).
...
In static resolvers (the "regular" ones), the input and output of a single invocation
is always fixed.
