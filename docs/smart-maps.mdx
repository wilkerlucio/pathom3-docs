...
consider that depending on the index and the current data, a simple `print` of the smart
map can lead to infinite loops due to the recursive properties of smart maps.
:::
