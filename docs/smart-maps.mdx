...
Sometimes the result will be unexpected, to debug the smart map you can use the `psm/sm-get-debug`
function to return the [run  stats](runner.mdx#run-stats) of the process:
